...
public class Run {
    ...
    private void runMethod() throws StreamCorruptedException {
        switch (selected){
            ...
            case "b": runPullWithDiameter = new RunPullWithDiameter("\\loetstellen.jpg", "\\expectedCentroids.txt", "\\picturePullWithDiameter.png", "\\resultsPushWithDiameter.txt"); break;
